  ...
  <div class="container">
    <div class="wrapper-login" style="max-width: 100%">
      <div class="row">
        ...
        <div id="CekBerkas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none ;" class=" col-md-12 detail">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="card-body">
                <div>
                  <h3 class="bold">BERKAS YANG BELUM DIDAPATKAN</h3>
                  <br>
                  <h4 id="Berkas"></h4>
                </div>

                <div class="card-footer">
                  <button data-dismiss="modal" class="btn btn-danger" style="padding: 5px 30px;">
                    OKE
                  </button>
                </div>
              </div>
