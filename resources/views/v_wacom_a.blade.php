...
<body>
    <div class="timpa">
        ...
        <div class="tengah">
            <P class="bukti">BUKTI TANDA TERIMA DOKUMEN KELULUSAN PERIODE WISUDA 62</P>
            <div class="foto">
            ...
            <div>
                <table>
                    <tr>
                        <td>1.</td>
                        <td>Ijazah S1 dan 3 Rangkap Legalisir Ijazah S1</td>
                    </tr>
                    <tr>
                        <td>2.</td>
                        <td>Transkrip Nilai Akademik S1 dan 3 Rangkap Legalisir Transkrip Nilai Akademik S1</td>
                    </tr>
                    <tr>
                        <td>3.</td>
                        <td>Dokumen Pendukung Ijazah dan 3 Rangkap Legalisir Dokumen Pendukung Ijazah</td>
                    </tr>
                    <tr>
                        <td>4.</td>
                        <td>Kartu Alumni</td>
